...
class HomeSettingModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'feature1_image', 'feature2_image', 'feature3_image',
        'about_title', 'about_description1', 'about_description2', 'about_list1', 'about_list2', 'about_list3', 'about_image', 'visi', 'misi',
